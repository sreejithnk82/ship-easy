...
function seedCustomerSpreadsheet_(ss) {
  var specs = [
    [SHEETS.PRODUCTS, ['product_id', 'name', 'content', 'description', 'declared_value', 'weight_g', 'length_cm', 'width_cm', 'height_cm', 'variants', 'created_at', 'status', 'created_by', 'verified_by', 'verified_at']],
    ...
    [SHEETS.ORDERS, ['order_id', 'batch_id', 'client_order_id', 'tracking_id', 'product_id', 'extra_product_ids', 'variant', 'extra_variants', 'receiver_name', 'receiver_phone', 'receiver_pincode', 'receiver_line1', 'receiver_line2', 'receiver_state', 'sender_address_id', 'status', 'operator_email', 'created_at', 'manifest_id', 'shipped_at', 'exported_at', 'export_id', 'voided_at', 'voided_by']],
